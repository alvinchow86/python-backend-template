...
from alvinchow_service.app.monitoring import initialize_sentry
from alvinchow_service.api.grpc.endpoints import AlvinChowServiceServicer
from alvinchow_service_protobuf import alvinchow_service_pb2_grpc
from alvinchow_service.api.grpc.interceptors import DefaultInterceptor
...
def create_grpc_server(address='[::]:50051', num_workers=DEFAULT_NUM_WORKERS):
    ...
    alvinchow_service_pb2_grpc.add_AlvinChowServiceServicer_to_server(
