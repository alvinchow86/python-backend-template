...
from alvinchow_service.app import celery    # noqa  # make sure Celery is loaded
from alvinchow_service.app.configuration import config    # noqa
from alvinchow_service.app.logging import setup_logging
from alvinchow_service.app.redis import setup_redis
from alvinchow_service.db.base import initialize_database
